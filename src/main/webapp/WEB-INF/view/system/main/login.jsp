...
<head>
    ...
    <link rel="icon" href="${car}/static/favicon.ico">
...
<form class="layui-form" id="loginFrm" method="post" action="${car}/login/login.action">
    <div class="login_face"><img src="${car}/static/images/face.jpg" class="userAvatar"></div>
    ...
    <div class="layui-form-item input-item" id="imgCode">
        ...
        <img src="${car}/login/getCode.action" onclick="this.src=this.src+'?'">
    </div>
